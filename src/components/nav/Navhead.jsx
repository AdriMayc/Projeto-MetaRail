...
export default function NavbarHeader() {
  ...
  return (
    <nav className="w-full md:h-24 h-12 bg-[#4A589A] font-sans z-50 fixed">
      {/* Navbar Top */}
      <div
        id="navbarMain"
      ...
      >
        ...
        <div className="md:w-full  md:pr-0  md:flex md:justify-center">
          <input
            ...
            md:w-1/3 md:h-10 md:z-0 searchBar md:left-0 md:pt-2.5 md:bg-[#6077E0] rounded-full placeholder-[#fffffF] border-none
            font-semibold text-xl md:text-[#ffffff]  focus:outline-none focus:ring-[#5F5AA2] focus:ring-4 md:focus:ring-[#5F5AA2]`}
            type="text"
          />
